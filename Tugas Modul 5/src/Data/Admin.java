...
public class Admin extends User implements iMenu, displayBooks {
    ...
    public void login() throws IllegalAdminAccessException {
    ...
    private void inputBook() {
        ...
        switch (bookType) {
            case 1:
                ...
                daftarBuku.add(new HistoryBooks(idBuku, judul, stok, category, author));
                break;
            case 2:
                idBuku = generateId("SB");
                daftarBuku.add(new StoryBooks(idBuku, judul, stok, category, author));
                break;
            case 3:
                idBuku = generateId("TB");
                daftarBuku.add(new TextBooks(idBuku, judul, stok, category, author));
                break;
            default:
                System.out.println("Pilihan tidak valid!");
                return;
